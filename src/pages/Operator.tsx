...
import { Download, Upload, CheckCircle, XCircle, LogOut, Power, Users } from 'lucide-react';
...
type MainView = 'deposits' | 'withdrawals' | 'bot-activation';
...
export default function Operator() {
  ...
  const handleBotActivation = async (activate: boolean) => {
    ...
    const days = activate ? parseInt(activationDays) : 0;
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-slate-800/50 backdrop-blur-xl border border-cyan-500/20 rounded-2xl p-8 shadow-[0_0_50px_rgba(34,211,238,0.15)]">
            {loading ? (
              ...
              mainView === 'bot-activation' ? renderBotActivation() : renderTransactions()
            )}
          </div>
        </div>
      </div>
