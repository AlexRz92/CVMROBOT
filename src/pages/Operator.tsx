...
import { CheckCircle, XCircle, LogOut, Power, Users, UserCheck } from 'lucide-react';
...
type MainView = 'bot-activation' | 'user-approval';
      ...
      <div className="relative z-10 flex-1 p-8 overflow-y-auto">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-white mb-6">
            {mainView === 'bot-activation' ? 'Activación del Bot' : 'Aprobación de Usuarios'}
          </h2>
          ...
          <div className="bg-slate-800/50 backdrop-blur-xl border border-cyan-500/20 rounded-2xl p-8 shadow-[0_0_50px_rgba(34,211,238,0.15)]">
            {loading ? (
              ...
              mainView === 'bot-activation' ? renderBotActivation() : renderUserApproval()
            )}
          </div>
        </div>
      </div>
