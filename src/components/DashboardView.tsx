...
import { DollarSign, Send, Wallet, LogOut as LogOutIcon, MessageSquare, Clock, Sparkles } from 'lucide-react';
  ...
  return (
    <div className="space-y-6 relative">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
        ...
        <div className="lg:col-span-2 bg-gradient-to-br from-cyan-900/30 to-blue-900/30 backdrop-blur-sm border border-cyan-700/50 rounded-xl p-6 relative overflow-hidden">
          <div className="absolute inset-0 bg-black/60 backdrop-blur-md z-10 flex items-center justify-center">
            <div className="text-center">
              <div className="mb-4 inline-block p-6 bg-yellow-500/10 rounded-full border-4 border-yellow-500/30">
                <Sparkles className="w-16 h-16 text-yellow-400" />
              </div>
              <h4 className="text-3xl font-bold text-yellow-400 mb-2">EN CONSTRUCCION</h4>
              <p className="text-gray-300">Proximamente disponible</p>
            </div>
          </div>
          ...
          {loadingPlans ? (
            ...
            <div className="space-y-3">
              {plans.slice(0, 2).map((plan) => (
                <div
                  key={plan.id}
                  className="bg-gradient-to-br from-cyan-900/40 to-blue-900/40 border border-cyan-700/30 rounded-lg p-4"
                >
