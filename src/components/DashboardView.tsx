        ...
        <div className="bg-gradient-to-br from-blue-900/40 to-cyan-900/40 backdrop-blur-sm border border-blue-700/50 rounded-xl p-6 flex flex-col">
          ...
          <div className="flex justify-center items-center flex-1 mb-4">
            <img
              src="/inicio.png"
              alt="Bot"
              className={`w-full h-auto object-contain ${botActivation?.is_active ? 'animate-pulse drop-shadow-[0_0_20px_rgba(34,211,238,0.8)]' : 'opacity-50'}`}
            />
          </div>
          ...
          <div className="text-center mt-6">
            ...
            {botActivation?.is_active && botActivation.days_remaining > 0 && (
              <div className="mt-4 bg-emerald-500/10 border border-emerald-500/30 rounded-lg p-3">
                <p className="text-sm text-emerald-400 mb-1">Tiempo Restante</p>
                <p className="text-3xl font-bold text-emerald-300">
                  {botActivation.days_remaining} {botActivation.days_remaining === 1 ? 'día' : 'días'}
                </p>
              </div>
            )}
          </div>
