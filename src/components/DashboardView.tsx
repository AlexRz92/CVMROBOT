...
export default function DashboardView() {
  ...
  const handleConfirmPlanSelection = () => {
    ...
    setSelectedPlanForChange(selectedPlanForDetails);
  };

  const handleConfirmPlanFromModal = () => {
        ...
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center p-4 z-50">
          <div className="bg-slate-800 border border-cyan-500/30 rounded-2xl max-w-md w-full p-6">
            ...
            <div className="flex gap-4">
              ...
              <button
                onClick={handleConfirmPlanFromModal}
          ...
          <div className="bg-slate-800 border border-cyan-500/30 rounded-2xl max-w-xl w-full p-6">
            ...
            <div className="flex gap-4">
              ...
              <button
                ...
                className="flex-1 py-3 bg-gradient-to-r from-cyan-600 to-blue-600 text-white rounded-lg hover:shadow-lg transition-all font-medium"
              >
                Seleccionar Plan
              </button>
            </div>
